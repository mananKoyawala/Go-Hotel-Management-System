...
type Reservation struct {
	...
	Check_in_time     string             `bson:"check_in_time,omitempty" json:"check_in_time,omitempty"`
	Check_out_time    string             `bson:"check_out_time,omitempty" json:"check_out_time,omitempty"`
